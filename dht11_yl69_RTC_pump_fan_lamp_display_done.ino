...
void water_pump(float humNow, String _time)
  ...
  if ( ((hum < HUM_MIN) && ((hh == 22) && (mm == 20) && ((ss >= 3) && (ss <= 45))) ) || 
  ( (hum >= HUM_MIN) && (hum - HUM_MIN < 20) && ((hh == 22) && (mm == 20) && ((ss >= 3) && (ss <= 28))) ) 
  || ( (hum >= HUM_MIN + 20) && (hum - HUM_MIN < 45) && ((hh <= 10) && (mm == 15) && ((ss >= 2) && (ss <= 9))) ) )  //
  {
    digitalWrite(VODPOMPA_PIN, HIGH);
  }
  /*elif ((hum - HUM_MIN < 40) && ((hh == 22) && (mm == 0) && ((ss >= 0) && (ss <= 20))) )  //
  {
...
void water_valve(float humNow, String _time)
  ...
  int mm = _time.substring(3,5).toInt();
  int ss = _time.substring(6,8).toInt();
  if ( ((hum < HUM_MIN) && ((hh == 22) && (mm == 20) && ((ss >= 0) && (ss <= 48))) ) || 
  ( (hum > HUM_MIN) && (hum - HUM_MIN < 20) && ((hh == 22) && (mm == 20) && ((ss >= 0) && (ss <= 31))) ) 
  || ( (hum > HUM_MIN + 20) && (hum - HUM_MIN < 45) && ((hh <= 10) && (mm == 15) && ((ss >= 0) && (ss <= 11))) ) )  //
  {
...
void loop() {
  ...
  Serial.println(g_h);  
  float percentage_g_h = map(g_h, 780, 860, 0, 100);
  ...
  if ( ((hh == 0) && (mm == 0)) || ((hh == 1) && (mm > 0) && (mm <= 3) && ((ss >= 0) && (ss <= 40))) )
    {
